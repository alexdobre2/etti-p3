...
# Cheia API și antetul pentru API-ul Hotels
headers = {
...
def search():
    ...
    if response.status_code == 200:
            ...
            if item.get('@type') == 'gaiaHotelResult':
                ...
                if hotel_id and region_id:
                    ...
                    for offer in hotel_offers:
                        offer['hotel_name'] = hotel_name  # Adăugăm numele hotelului în fiecare ofertă
                        ...
                        # print("pret num: ", offer['numeric_price'])
        ...
        return "Eroare la căutarea hotelurilor"
    ...
    if response.status_code == 200:
        ...
        try:
            for unit in offers_data['data']['propertyOffers']['units']:
                room_name = unit.get('header', {}).get('text')  # Numele camerei
